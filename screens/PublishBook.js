    ...
    handleChoosePhoto = () => {
        ...
        ImagePicker.launchImageLibrary(options, response => {
            ...
            if (response.assets[0].uri) {
                this.setState({cover: response.assets[0]})
            ...
            <View style={styles.container}>
                <View style={styles.navContainer}>
                    ...
                    <View style={styles.heading}>
                        <Text style={{fontSize: 23, fontWeight: 'bold'}}>Publish a book</Text>
                    </View>
                    ...
                    <ScrollView style={styles.scrollView}>
                        ...
                        <View style={{flex: 1, flexDirection: 'row', marginHorizontal: 30}}>
                            ...
                            <View >
                                ...
                                <TouchableOpacity onPress={this.handleChoosePhoto} style={{height: 30, width: 90, backgroundColor: '#6495ED',
                        ...
                        <View style={styles.submitContainer}>
                            <TouchableOpacity style={styles.submit}
                                                onPress={() => //console.log(cover.uri)
                                                    ...
                                                    axios.post('https://vivilio.herokuapp.com/api/books', datas,
