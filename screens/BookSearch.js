...
export default class BookSearch extends Component{
    ...
    getUserList= () => {
        AsyncStorage.getItem('access_token').then((access_token) => {
            axios.get(`https://vivilio.herokuapp.com/api/search/books?query=${this.state.query}`,
        ...
        return(
            <View style={styles.container}>
                ...
                <View style={{paddingTop: 60, alignItems: 'center', justifyContent: 'center'}}>
                    <Text style={{color: '#748c94', }}>Books were found: {Object.keys(this.state.books).length}
                    </Text>
                </View>
